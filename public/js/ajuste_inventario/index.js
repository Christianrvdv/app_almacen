/**
 * public/js/ajuste_inventario/index.js
 * Lógica específica para la página de listado de Ajustes de Inventario.
 */
...
export function initIndexPage() {
    ...
    console.log('Listado de Ajustes de Inventario inicializado.');
}

// Función para limpiar búsqueda (definida en ámbito global)
window.clearSearch = function() {
    window.location.href = "{{ path('app_ajuste_inventario_index') }}";
}
