 ...
 */
final class Version20251030193310 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE producto (id INT AUTO_INCREMENT NOT NULL, categoria_id INT DEFAULT NULL, proveedor_id INT DEFAULT NULL, nombre VARCHAR(255) NOT NULL, descripcion VARCHAR(255) DEFAULT NULL, codigo_barras VARCHAR(255) DEFAULT NULL, precio_compra NUMERIC(10, 2) NOT NULL, precio_venta_actual NUMERIC(10, 2) NOT NULL, stock_minimo INT NOT NULL, activo TINYINT(1) NOT NULL, fecha_creaccion DATETIME NOT NULL, fecha_actualizacion DATETIME NOT NULL, INDEX IDX_A7BB06153397707A (categoria_id), INDEX IDX_A7BB0615CB305D73 (proveedor_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE venta (id INT AUTO_INCREMENT NOT NULL, cliente_id INT DEFAULT NULL, fecha DATETIME NOT NULL, total NUMERIC(10, 2) NOT NULL, tipo_venta VARCHAR(255) NOT NULL, estado VARCHAR(255) NOT NULL, INDEX IDX_8FE7EE55DE734E51 (cliente_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
